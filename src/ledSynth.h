...
public:
    ...
    const double blackbodyColor[91 * 3] =
    {
    ...
    ofFloatColor temperatureToColor(int temp)
    {
        ...
        temp_index = ofClamp(temp_index, 0, 90 * 3);
        
        float r = ofLerp(blackbodyColor[temp_index], blackbodyColor[temp_index + 3], alpha);
        float g = ofLerp(blackbodyColor[temp_index + 1], blackbodyColor[temp_index + 3 + 1], alpha);
        float b = ofLerp(blackbodyColor[temp_index + 2], blackbodyColor[temp_index + 3 + 2], alpha);
